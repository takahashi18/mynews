...
return new class extends Migration
{
    ...
    //image_pathの右にある　->nullable()という記述は、画像のパス空でも保存できるという意味。つまり他の４つは全て保存時に必ず値が入るカラムに設定される。

    // idとtimestampsはレコードが新規作成される際に自動で埋まる、titleとbodyは入力時に必須チェックをしているから、カナアズあたいが入る
